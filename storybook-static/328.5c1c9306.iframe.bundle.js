...
(self.webpackChunkt_react_sudoku = self.webpackChunkt_react_sudoku || []).push([
  [328],
  {
    './node_modules/@storybook/addon-docs/dist/DocsRenderer-3PUGWF3O.mjs': function(
      ...
      var react = __webpack_require__('./node_modules/react/index.js'),
        ...
        ErrorBoundary = class extends react.Component {
          ...
          componentDidCatch(err) {
            let { showException: showException } = this.props;
            showException(err);
          }
          render() {
            let { hasError: hasError } = this.state,
