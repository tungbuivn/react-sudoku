  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = function(chunkId) {
      return (
        ({
          ...
          402: 'stories-Reset-stories',
          769: 'stories-Configure-mdx',
          876: 'stories-Game-stories',
        }[chunkId] || chunkId) +
        '.' +
        {
          48: '876b1473',
    ...
    (__webpack_require__.l = function(url, done, key, chunkId) {
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute('data-webpack') == 't-react-sudoku:' + key
            ) {
              script = s;
              break;
            }
        ...
        script ||
          ...
          script.setAttribute('data-webpack', 't-react-sudoku:' + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (function() {
      ...
      var webpackJsonpCallback = function(parentChunkLoadingFunction, data) {
        ...
        chunkLoadingGlobal = (self.webpackChunkt_react_sudoku =
