...
Check the render method of \`` +
      ...
      var TOP_ABORT = 'abort',
        ...
        TOP_ANIMATION_ITERATION = getVendorPrefixedEventName(
          'animationiteration'
        ),
      ...
      function flushSyncCallbackQueueImpl() {
        if (!isFlushingSyncQueue && syncQueue !== null) {
          ...
          try {
            ...
            throw (syncQueue !== null && (syncQueue = syncQueue.slice(i + 1)),
        ...
        switch (resolvedTag) {
          case FunctionComponent:
            return (
              ...
              (workInProgress2.type = Component = resolveFunctionForHotReloading(
                Component
              )),
          ...
          case ForwardRef:
            return (
              (workInProgress2.type = Component = resolveForwardRefForHotReloading(
                Component
              )),
        ...
        if (expirationTime !== NoWork) {
          ...
          if (
            ...
            if (
              ...
              throw (stopInterruptedWorkLoopTimer(),
              prepareFreshStack(root2, expirationTime),
        ...
        switch (((workInProgressRoot = null), exitStatus)) {
          ...
          case RootSuspended: {
            ...
            expirationTime === lastSuspendedTime &&
              (root2.nextKnownPendingLevel = getRemainingExpirationTime(
                finishedWork
              ));
...
function usePopperTooltip(config, popperOptions) {
  ...
  var finalConfig = Object.keys(defaultConfig).reduce(function(config2, key) {
    ...
    defaultModifiers2 = React3.useMemo(function() {
  ...
  var _usePopper = usePopper(
    ...
    isTriggeredBy = React3.useCallback(function(trigger) {
