              ...
              return (i /= l) < 0.36363636363636365
                ...
                : i < 0.7272727272727273
                  ...
                  : i < 0.9090909090909091
                    ...
                    : u * (7.5625 * (i -= 0.9545454545454546) * i + 0.984375) +
                      a;
            },
...
`;
  ...
  function E1(t) {
    let { debounce: e, scroll: n, polyfill: r, offsetSize: o } =
  ...
  function bh(t) {
    ...
    let { overflow: n, overflowX: r, overflowY: o } = window.getComputedStyle(
      t
    );
    return (
  ...
  var Xs,
    ...
    Fe = v(() => {
      (Xs = (t, e) => n => Math.max(Math.min(n, e), t)),
        ...
        (Nn = /(-)?([\d]*\.?[\d])+/g),
        (zo = /(#[0-9a-f]{6}|#[0-9a-f]{3}|#(?:[0-9a-f]{2}){2,4}|(rgb|hsl)a?\((-?[\d\.]+%?[,\s]+){2,3}\s*\/*\s*[\d\.]+%?\))/gi),
