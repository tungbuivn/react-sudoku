try {
  ...
  var ni = b((YR, ri) => {
    ...
    G[Bh] = G[qh] = G[Vh] = G[Nh] = G[Kh] = G[jh] = G[Lh] = G[Mh] = G[kh] = G[
      $h
    ] = G[zh] = G[Hh] = G[Uh] = G[Wh] = G[Gh] = !1;
    function om(e) {
    ...
    Fp.exports = function() {
      var t,
        ...
        o = {
          assert: function(a) {
            if (!o.has(a))
              throw new b1('Side channel does not contain ' + g1(a));
          },
          get: function(a) {
    ...
    Vp = ye({
      '../../node_modules/entities/lib/encode.js'(e) {
        ...
        function f(R) {
          ...
          return (
            j.unshift('[' + q.join('') + ']'), new RegExp(j.join('|'), 'g')
          );
        }
        var g = /(?:[\x80-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])/g,
          E =
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
                ...
                value: function(S) {
                  ...
                  return (
                    ...
                    de(S.join(''), C, function(F, k) {
                      var ue = x(P, F, k, C);
                      ue && D.push(ue),
                        C.stream && (_.stickyStack = ee(_.stickyStack, F, k));
                    }),
                    P.length && D.push(O(P)),
                    D.join('')
                  );
  ...
  var xA = /^#[a-fA-F0-9]{6}$/,
    ...
    RA = /^rgb(?:a)?\(\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i,
  ...
  var US = Oo,
    ...
    hf = e => {
      let {
        ...
        f = (0, xS.default)(e, WS),
        [g, E] = me(void 0),
        { themeClass: v, currentTheme: w, currentColorScheme: x } = qr(
...
`);
    ...
    ww = H('button', {
      ...
      '&:focus-visible': {
        ...
        background:
          r.status === M.ERROR ? 'transparent' : e.background.hoverable,
      },
        ...
        () => {
          r(B => {
            ...
            return {
              ...B,
              interactions: N,
              interactionsCount: N.filter(({ method: V }) => V !== 'step')
                .length,
            };
          });
        },
