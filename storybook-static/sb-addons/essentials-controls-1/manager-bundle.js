try {
  ...
  var Hs = F((kL, Us) => {
    ...
    Lt.prototype.clear = aE;
    Lt.prototype.delete = oE;
    Lt.prototype.get = iE;
    Lt.prototype.has = uE;
    Lt.prototype.set = sE;
    Us.exports = Lt;
  ...
  var oo = F((Pj, pl) => {
    ...
    on.prototype.add = on.prototype.push = HE;
    on.prototype.has = zE;
    pl.exports = on;
  });
  var hl = F((Mj, fl) => {
  ...
  var Xl = F((p$, Yl) => {
    ...
    var ev = vt(),
      ...
      ce = {};
    ce[bv] = ce[Ev] = ce[Av] = ce[vv] = ce[Dv] = ce[Cv] = ce[xv] = ce[Sv] = ce[
      Fv
    ] = !0;
    ce[nv] = ce[av] = ce[gv] = ce[ov] = ce[yv] = ce[iv] = ce[uv] = ce[sv] = ce[
      lv
    ] = ce[cv] = ce[dv] = ce[pv] = ce[fv] = ce[hv] = ce[mv] = !1;
    function wv(e) {
  ...
  var mn = F((Sr, Ut) => {
    ...
    var Tv = to(),
      ...
      Fr = Ql && typeof Ut == 'object' && Ut && !Ut.nodeType && Ut,
      _v = Fr && Fr.exports === Ql,
      fo = _v && Tv.process,
      Ov = (function() {
        try {
    ...
    function WD(e, t, r, n) {
      ...
      for (; ++a < o; ) {
        ...
        if (i && u[2]) {
          ...
          if (!(m === void 0 ? UD(y, p, HD | zD, n, E) : m)) return !1;
        }
      }
      return !0;
    }
  ...
  var Vf = F((rK, Gf) => {
    ...
    var y5 = an(),
      ...
      le = {};
    le[Hf] = le[U5] = le[e3] = le[t3] = le[H5] = le[z5] = le[r3] = le[n3] = le[
      a3
    ] = le[o3] = le[i3] = le[V5] = le[K5] = le[Wf] = le[Y5] = le[X5] = le[
      J5
    ] = le[Q5] = le[u3] = le[s3] = le[l3] = le[c3] = !0;
    le[W5] = le[zf] = le[Z5] = !1;
  ...
  var zn = F((CJ, yh) => {
    ...
    var fh,
      ...
      Mr = $n(),
      Un = ph(),
      bT = Mr.call(Function.call, Array.prototype.concat),
      ...
      xT = function(t, r) {
        var n = t,
          a;
        if ((Un(hh, n) && ((a = hh[n]), (n = '%' + a[0] + '%')), Un(Ft, n))) {
          var o = Ft[n];
  ...
  var Ch = F((wJ, Wn) => {
    ...
    wt ? wt(Wn.exports, 'apply', { value: Eh }) : (Wn.exports.apply = Eh);
  });
  var wh = F((OJ, Fh) => {
    'use strict';
    l();
    ...
    Vh.exports = function e(t, r, n, a) {
      ...
      if (zh(t)) {
        var b = er
          ...
          : fi.call(t);
        return typeof t == 'object' && !er ? Lr(b) : b;
      }
      if (XT(t)) {
        for (
          ...
          x += ' ' + S[B].name + '=' + Hh(NT(S[B].value), 'double', o);
        return (
          (x += '>'),
...
` +
  ...
  var om = F((rQ, am) => {
    ...
    var rm = Xh(),
      ...
      Si = {},
      B_ = function e(t, r, n, a, o, i, u, s, p, y, E, m, g, A, b, x) {
        for (
          var S = t, B = x, I = 0, L = !1;
          (B = B.get(Si)) !== void 0 && !L;
        ...
        for (
          var H = a && at(S) && S.length === 1 ? r + '[]' : r, ee = 0;
          ee < U.length;
          ++ee
        ) {
          var Q = U[ee],
      ...
      function S() {
        ...
        for (P = r.charAt(a), ++a; a < n; )
          if (((M = b()), M === P)) {
            ...
            if (((M = b()), s.code.isLineTerminator(M.charCodeAt(0))))
...
\u2028\u2029])`;
      ...
      function p(S) {
        ...
        return (
          ...
          e.includeHtml && S.childNodes.length
            ? t.call(S.childNodes, function(L) {
    ...
    Jg = Ze(() => {
      ...
      (XR = j.div({ position: 'relative', maxWidth: 250 })),
        ...
        (lr = e => {
          ...
          if (i4.test(e)) {
            let [i, u, s, p] = Gg(e),
              [y, E, m] = je.default.rgb.hsl([i, u, s]) || [0, 0, 0];
            return {
              valid: t,
              value: e,
          ...
          if (u4.test(e)) {
            let [i, u, s, p] = Gg(e),
              [y, E, m] = je.default.hsl.rgb([i, u, s]) || [0, 0, 0];
            return {
              valid: t,
              value: e,
        ...
        (p4 = (e, t, r) => {
          ...
          let o = ot(
            ...
            i = ge(
              u => {
                u?.valid &&
                  (o.some(s => ca(s[r]) === ca(u[r])) || a(s => s.concat(u)));
              },
              [r, o]
            );
  ...
  var $2 = /^#[a-fA-F0-9]{6}$/,
    ...
    V2 = /^hsl(?:a)?\(\s*(\d{0,3}[.]?[0-9]+(?:deg)?)\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i;
  function kt(e) {
              ...
              let I = (function(N) {
                ...
                k = (b[w] = (function(N, U) {
                  return N === 'style'
                    ...
                    : N === 'href'
                      ? Gt(U)
                      : (U.match(LS) && (U = U.slice(1, U.length - 1)),
                        U === 'true' || (U !== 'false' && U));
                })(I, L));
              typeof k == 'string' &&
                (Ho.test(k) || zo.test(k)) &&
    ...
    let i = [],
      ...
      s = {
        ...
        footnoteReference: {
          ...
          h: (g, A, b) =>
            n('a', { key: b.k, href: Gt(g.B) }, n('sup', { key: b.k }, g.v)),
        },
        gfmTask: {
          t: ct(kS),
          i: re.HIGH,
        ...
        link: {
          ...
          h: (g, A, b) =>
            n('a', { key: b.k, href: Gt(g.B), title: g.F }, A(g.v, b)),
        },
        ...
        refLink: {
          ...
          h: (g, A, b) =>
            u[g.P]
              ? n(
                  'a',
                  { key: b.k, href: Gt(u[g.P].B), title: u[g.P].F },
                  A(g.v, b)
                )
      ...
      ((s.htmlBlock = {
        ...
        l(g, A, b) {
          let [, x] = g[3].match(sF),
            S = new RegExp(`^${x}`, 'gm'),
            B = g[3].replace(S, ''),
            I = ((L = B), mF.some(U => U.test(L)) ? vF : Sn);
          var L;
      ...
      function g(A, b = {}) {
        if (Array.isArray(A)) {
          ...
          for (let I = 0; I < A.length; I++) {
            ...
            let L = g(A[I], b),
              w = typeof L == 'string';
            w && B ? (S[S.length - 1] += L) : L !== null && S.push(L), (B = w);
          }
          return (b.k = x), S;
        }
        return E(A, g, b);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let a of Fm(t))
          !hO.call(e, a) &&
            ...
            Sm(e, a, {
              get: () => t[a],
              enumerable: !(n = pO(t, a)) || n.enumerable,
            });
      return e;
    },
    ta = (e, t, r) => (
  ...
  function wm(e) {
    ...
    return (
      e instanceof CustomEvent &&
        yO.filter(r => e[r] !== void 0).forEach(r => {
          t[r] = e[r];
        }),
      t
    );
    ...
    km = Le({
      'node_modules/get-intrinsic/index.js'(e, t) {
        ...
        var s = function() {
          ...
          L = S.call(Function.apply, Array.prototype.splice),
  ...
  var _O =
    ...
    PO = OO || RO || Function('return this')(),
    Pi = PO,
    IO = Pi.Symbol,
    nr = IO,
    Nm = Object.prototype,
    kO = Nm.hasOwnProperty,
    NO = Nm.toString,
  ...
  var VO = GO,
    KO = '[object Symbol]';
  function YO(e) {
    return typeof e == 'symbol' || (VO(e) && Mm(e) == KO);
  }
  var Ii = YO;
  function XO(e, t) {
    for (var r = -1, n = e == null ? 0 : e.length, a = Array(n); ++r < n; )
  ...
  var jm = t8,
    r8 = '[object AsyncFunction]',
    n8 = '[object Function]',
    a8 = '[object GeneratorFunction]',
    o8 = '[object Proxy]';
  function i8(e) {
    if (!jm(e)) return !1;
    var t = Mm(e);
    return t == n8 || t == a8 || t == r8 || t == o8;
  }
  var u8 = i8,
    s8 = Pi['__core-js_shared__'],
    Oi = s8,
    Om = (function() {
  ...
  var h8 = f8,
    m8 = /[\\^$.*+?()[\]{}|]/g,
    g8 = /^\[object .+?Constructor\]$/,
    y8 = Function.prototype,
    b8 = Object.prototype,
    E8 = y8.toString,
    A8 = b8.hasOwnProperty,
    v8 = RegExp(
      '^' +
        E8.call(A8)
          .replace(m8, '\\$&')
  ...
  function O8(e, t) {
    ...
    return r == 'number' ||
      ...
      Ii(e)
      ? !0
      : _8.test(e) || !T8.test(e) || (t != null && e in Object(t));
  }
  var R8 = O8,
    P8 = qm(Object, 'create'),
    Gr = P8;
  ...
  var M8 = N8,
    ...
    j8 = Object.prototype,
    q8 = j8.hasOwnProperty;
  function $8(e) {
    var t = this.__data__;
    if (Gr) {
      var r = t[e];
      return r === L8 ? void 0 : r;
    }
    return q8.call(t, e) ? t[e] : void 0;
  }
  var U8 = $8,
    H8 = Object.prototype,
    z8 = H8.hasOwnProperty;
  function W8(e) {
    var t = this.__data__;
    return Gr ? t[e] !== void 0 : z8.call(t, e);
  }
  var G8 = W8,
    V8 = '__lodash_hash_undefined__';
  function K8(e, t) {
    var r = this.__data__;
    return (
      (this.size += this.has(e) ? 0 : 1),
      (r[e] = Gr && t === void 0 ? V8 : t),
      this
    );
  }
  var Y8 = K8;
  ...
  ar.prototype.clear = k8;
  ar.prototype.delete = M8;
  ar.prototype.get = U8;
  ar.prototype.has = G8;
  ar.prototype.set = Y8;
  var Rm = ar;
  ...
  var J8 = X8;
  function Q8(e, t) {
    for (var r = e.length; r--; ) if (B8(e[r][0], t)) return r;
    return -1;
  }
  var na = Q8,
    Z8 = Array.prototype,
  ...
  var k6 = I6;
  function N6(e, t) {
    return ki(e) ? e : R8(e, t) ? [e] : P6(k6(e));
  }
  var M6 = N6,
    L6 = 1 / 0;
  function j6(e) {
...
` &&
  ...
  var R4 = j(A4)({
    ...
    Qi = ({
      ...
      let [E, m] = ne(i),
        ...
        N = ge(async V => {
          let {
            createCopyToClipboardFunction: H,
  ...
  var Ty = class extends et {
    ...
    renderNotCollapsed() {
      let {
        ...
        { minus: U, plus: V, delimiter: H, ul: ee, addForm: Q } = y(
          e,
          t,
          r,
          n,
        ...
        _ = me(S, { onClick: u, className: 'rejt-minus-menu', style: U }),
        q = !0,
        W = '[',
        X = ']';
      return h.createElement(
  ...
  var tu = class extends et {
    ...
    renderNotCollapsed() {
      let {
        ...
        { minus: U, plus: V, addForm: H, ul: ee, delimiter: Q } = y(
          e,
          t,
          r,
          n,
        ...
        q = me(S, { onClick: u, className: 'rejt-minus-menu', style: U }),
        W = Y.map(Z =>
          h.createElement(ga, {
            key: Z,
            name: Z,
  ...
  var mt = class extends et {
    ...
    render() {
      let {
        ...
        L = me(E, { onClick: this.handleCancelEdit }),
      ...
      '&::-webkit-slider-runnable-track': {
        background:
          e.base === 'light'
            ...
            ${e.color.green} 0%, ${e.color.green} ${((n - t) / (r - t)) *
                100}%, 
  ...
  `),
        n ??
          ...
          o.transformSource ??
          t.parameters.docs?.transformSource ??
          t.parameters.jsx?.transformSource?.(u, t) ||
          u
      );
    },
    My = (e, t, r) => {
